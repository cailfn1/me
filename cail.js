...
// detailed mini-illustration glyphs — gradient fills + highlights, guns.lol grade.
// gradient ids are prefixed per glyph (inline SVGs share the document namespace).
const CBADGE_SVG = {
  crown: '<svg viewBox="0 0 24 24"><defs><linearGradient id="cbg-crn" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ffe9a8"/><stop offset=".55" stop-color="#ffd166"/><stop offset="1" stop-color="#d9941f"/></linearGradient></defs><path fill="url(#cbg-crn)" d="M2.8 6.8l4.5 3.8L12 3.8l4.7 6.8 4.5-3.8-1.5 9.6h-15L2.8 6.8z"/><rect x="4.3" y="18" width="15.4" height="2.6" rx="1.3" fill="url(#cbg-crn)"/><circle cx="12" cy="12.4" r="1.35" fill="#a01a40"/><circle cx="7.7" cy="13.5" r=".95" fill="#a01a40"/><circle cx="16.3" cy="13.5" r=".95" fill="#a01a40"/><path fill="rgba(255,255,255,.5)" d="M5.2 8.9l2.1 1.7-.9 4h-.9l-.3-5.7z"/></svg>',
  blood: '<svg viewBox="0 0 24 24"><defs><linearGradient id="cbg-bld" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ff7a96"/><stop offset=".5" stop-color="#ff2d5e"/><stop offset="1" stop-color="#7a0f30"/></linearGradient></defs><path fill="url(#cbg-bld)" d="M12 2.1S5.3 10.3 5.3 14.6a6.7 6.7 0 0 0 13.4 0C18.7 10.3 12 2.1 12 2.1z"/><path fill="rgba(255,255,255,.5)" d="M9.4 8.1c-1.1 1.7-2.1 3.7-2.1 5 0 .6.5.8.8.3.3-.5.5-1.2 1-2.1.4-.9 1-1.9 1.4-2.6.4-.7-.5-1.5-1.1-.6z"/><ellipse cx="14.6" cy="16.4" rx="1.7" ry="2" fill="rgba(0,0,0,.18)"/></svg>',
  code:  '<svg viewBox="0 0 24 24"><defs><linearGradient id="cbg-dev" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ffc2d4"/><stop offset=".55" stop-color="#ff8aab"/><stop offset="1" stop-color="#c81e46"/></linearGradient></defs><rect x="2.4" y="3.8" width="19.2" height="16.4" rx="3" fill="rgba(255,138,171,.1)" stroke="url(#cbg-dev)" stroke-width="1.9"/><path d="M6.8 9.3l3.1 2.8-3.1 2.8" fill="none" stroke="url(#cbg-dev)" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"/><path d="M12.4 15h4.8" stroke="url(#cbg-dev)" stroke-width="2.1" stroke-linecap="round"/><circle cx="5.4" cy="6.6" r=".8" fill="#ff8aab"/><circle cx="7.9" cy="6.6" r=".8" fill="rgba(255,138,171,.55)"/></svg>',
  lift:  '<svg viewBox="0 0 24 24"><defs><linearGradient id="cbg-lft" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ff8aa0"/><stop offset=".5" stop-color="#ff5878"/><stop offset="1" stop-color="#8a1538"/></linearGradient></defs><rect x="1.8" y="9.2" width="2.2" height="5.6" rx="1" fill="url(#cbg-lft)"/><rect x="4.6" y="6.9" width="2.7" height="10.2" rx="1.2" fill="url(#cbg-lft)"/><rect x="20" y="9.2" width="2.2" height="5.6" rx="1" fill="url(#cbg-lft)"/><rect x="16.7" y="6.9" width="2.7" height="10.2" rx="1.2" fill="url(#cbg-lft)"/><rect x="7.3" y="11" width="9.4" height="2" rx="1" fill="url(#cbg-lft)"/><rect x="7.6" y="11.25" width="8.8" height=".6" rx=".3" fill="rgba(255,255,255,.45)"/><rect x="5" y="7.4" width=".8" height="9.2" rx=".4" fill="rgba(255,255,255,.28)"/><rect x="17.1" y="7.4" width=".8" height="9.2" rx=".4" fill="rgba(255,255,255,.28)"/></svg>',
  sword: '<svg viewBox="0 0 24 24"><defs><linearGradient id="cbg-ktn" x1="0" y1="1" x2="1" y2="0"><stop offset="0" stop-color="#8d96a6"/><stop offset=".5" stop-color="#dfe5ee"/><stop offset="1" stop-color="#ffffff"/></linearGradient></defs><path fill="url(#cbg-ktn)" d="M21.5 2.5c-4.8.6-9.8 2.9-13.4 6.5l-2.2 2.2 3.9 3.9 2.2-2.2c3.6-3.6 5.9-8.6 6.5-13.4z"/><path fill="rgba(255,255,255,.6)" d="M21.5 2.5c-3.8 1.6-7.6 4-10.6 7l-1.7 1.7 1.1 1.1 1.7-1.7c3-3 5.4-6.8 7-10.6z"/><circle cx="8" cy="13" r="1.9" fill="#e0436b"/><circle cx="8" cy="13" r=".8" fill="#2c0a1a"/><path d="M6.3 14.7l-3.4 3.4" stroke="#8a1538" stroke-width="3.2" stroke-linecap="round"/><path d="M5.6 15.4l1 1M4.3 16.7l1 1" stroke="#ff8aab" stroke-width="1" stroke-linecap="round"/><circle cx="2.6" cy="18.4" r="1.05" fill="#e0436b"/></svg>',
  moon:  '<svg viewBox="0 0 24 24"><defs><linearGradient id="cbg-mn" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#ffffff"/><stop offset=".55" stop-color="#d8dce4"/><stop offset="1" stop-color="#8e94a6"/></linearGradient></defs><path fill="url(#cbg-mn)" d="M20.6 13.4A8.9 8.9 0 1 1 10.6 3.3a7.1 7.1 0 0 0 10 10.1z"/><circle cx="9.3" cy="13.2" r="1.15" fill="rgba(0,0,0,.14)"/><circle cx="12.6" cy="16.8" r=".8" fill="rgba(0,0,0,.12)"/><circle cx="7.4" cy="9.6" r=".65" fill="rgba(0,0,0,.12)"/><path fill="#ffd9e3" d="M18.6 4.2l.5 1.3 1.3.5-1.3.5-.5 1.3-.5-1.3-1.3-.5 1.3-.5z"/><circle cx="21.2" cy="9.2" r=".7" fill="#ffd9e3"/></svg>',
};
