...
const CBADGE_SVG = {
  ...
  sword: '<svg viewBox="0 0 24 24"><defs><linearGradient id="cbg-ktn" x1="0" y1="1" x2="1" y2="0"><stop offset="0" stop-color="#8d96a6"/><stop offset=".5" stop-color="#dfe5ee"/><stop offset="1" stop-color="#ffffff"/></linearGradient></defs><path fill="url(#cbg-ktn)" d="M21.8 2.2c-5 1-10.2 3.7-13.7 7.2L6.7 10.8l2.5 2.5 1.4-1.4C14.1 8.4 16.8 3.2 21.8 2.2z"/><path fill="rgba(255,255,255,.55)" d="M21.8 2.2c-3.4 2.2-6.6 4.8-9.3 7.5l-1 1 .6.6 1-1c2.7-2.7 5.7-5.4 8.7-8.1z"/><circle cx="7.9" cy="12.2" r="1.55" fill="none" stroke="#e0436b" stroke-width="1.3"/><path d="M6.6 13.5l-3.5 3.5" stroke="#8a1538" stroke-width="2.6" stroke-linecap="round"/><path d="M5.9 14.2l.9.9M4.6 15.5l.9.9" stroke="#ff8aab" stroke-width=".9" stroke-linecap="round"/><circle cx="2.8" cy="17.3" r=".9" fill="#e0436b"/></svg>',
